...
int main()
{
    ...
    for(;;)
    {
        ...
        CyBle_ProcessEvents();
        sliderValue = Slider_GetValue(); 
        if (sliderValue != 0xFFFF)
        {            
            hueData.intensity = (uint8)sliderValue;
            RGB_SetHue(hueData);
        }
    }
}
...
void StackEventHandler( uint32 eventCode, void *eventParam )
{
    switch( eventCode )
    {
        ...
        case CYBLE_EVT_GAP_DEVICE_DISCONNECTED:
           Ble_ProcessGappDisconnectedEvent();
        break;
        ...
        case CYBLE_EVT_GATTS_WRITE_REQ:
            Ble_ProcessGattWriteEvent(eventParam);
        break;
