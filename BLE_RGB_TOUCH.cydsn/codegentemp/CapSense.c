...
reg32 * CapSense_pcTable[] = {
    (reg32 *)CapSense_Sns__SLIDER_0_e0__LS__PC, 
    (reg32 *)CapSense_Sns__SLIDER_0_e1__LS__PC, 
    (reg32 *)CapSense_Sns__SLIDER_0_e2__LS__PC, 
    (reg32 *)CapSense_Sns__SLIDER_0_e3__LS__PC, 
    (reg32 *)CapSense_Sns__SLIDER_0_e4__LS__PC, 
};

const uint8 CapSense_portTable[] = {
    CapSense_Sns__SLIDER_0_e0__LS__PORT, 
    CapSense_Sns__SLIDER_0_e1__LS__PORT, 
    CapSense_Sns__SLIDER_0_e2__LS__PORT, 
    CapSense_Sns__SLIDER_0_e3__LS__PORT, 
    CapSense_Sns__SLIDER_0_e4__LS__PORT, 
};

const uint32 CapSense_maskTable[] = {
    CapSense_Sns__SLIDER_0_e0__LS__MASK, 
    CapSense_Sns__SLIDER_0_e1__LS__MASK, 
    CapSense_Sns__SLIDER_0_e2__LS__MASK, 
    CapSense_Sns__SLIDER_0_e3__LS__MASK, 
    CapSense_Sns__SLIDER_0_e4__LS__MASK, 
};

const uint8 CapSense_pinShiftTbl[] = {
    (uint8) CapSense_Sns__SLIDER_0_e0__LS__SHIFT, 
    (uint8) CapSense_Sns__SLIDER_0_e1__LS__SHIFT, 
    (uint8) CapSense_Sns__SLIDER_0_e2__LS__SHIFT, 
    (uint8) CapSense_Sns__SLIDER_0_e3__LS__SHIFT, 
    (uint8) CapSense_Sns__SLIDER_0_e4__LS__SHIFT, 
};
