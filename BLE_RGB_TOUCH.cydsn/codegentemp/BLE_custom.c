...
const CYBLE_CUSTOMS_T cyBle_customs[0x02u] = {
    ...
    /* CapSlider service */
    {
        0x000Eu, /* Handle of the CapSlider service */ 
        {

            /* SLIDER_POS characteristic */
            {
                0x0010u, /* Handle of the SLIDER_POS characteristic */ 
    ...
    /* RGB_LED service */
    {
        0x0013u, /* Handle of the RGB_LED service */ 
        {

            /* RGB_DATA characteristic */
            {
                0x0015u, /* Handle of the RGB_DATA characteristic */ 
                
                /* Array of Descriptors handles */
                {
                    0x0016u, /* Handle of the Characteristic User Description 2 descriptor */ 
