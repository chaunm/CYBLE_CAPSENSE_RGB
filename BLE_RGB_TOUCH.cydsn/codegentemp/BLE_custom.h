...
#define CYBLE_CAPSLIDER_SERVICE_INDEX   (0x00u) /* Index of CapSlider service in the cyBle_customs array */
#define CYBLE_CAPSLIDER_SLIDER_POS_CHAR_INDEX   (0x00u) /* Index of SLIDER_POS characteristic */
#define CYBLE_CAPSLIDER_SLIDER_POS_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x00u) /* Index of Characteristic User Description descriptor */
#define CYBLE_CAPSLIDER_SLIDER_POS_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_INDEX   (0x01u) /* Index of Client Characteristic Configuration descriptor */

#define CYBLE_RGB_LED_SERVICE_INDEX   (0x01u) /* Index of RGB_LED service in the cyBle_customs array */
#define CYBLE_RGB_LED_RGB_DATA_CHAR_INDEX   (0x00u) /* Index of RGB_DATA characteristic */
#define CYBLE_RGB_LED_RGB_DATA_CHARACTERISTIC_USER_DESCRIPTION_2_DESC_INDEX   (0x00u) /* Index of Characteristic User Description 2 descriptor */
#define CYBLE_RGB_LED_RGB_DATA_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_INDEX   (0x01u) /* Index of Client Characteristic Configuration descriptor */


#define CYBLE_CAPSLIDER_SERVICE_HANDLE   (0x000Eu) /* Handle of CapSlider service */
#define CYBLE_CAPSLIDER_SLIDER_POS_DECL_HANDLE   (0x000Fu) /* Handle of SLIDER_POS characteristic declaration */
#define CYBLE_CAPSLIDER_SLIDER_POS_CHAR_HANDLE   (0x0010u) /* Handle of SLIDER_POS characteristic */
#define CYBLE_CAPSLIDER_SLIDER_POS_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x0011u) /* Handle of Characteristic User Description descriptor */
#define CYBLE_CAPSLIDER_SLIDER_POS_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_HANDLE   (0x0012u) /* Handle of Client Characteristic Configuration descriptor */

#define CYBLE_RGB_LED_SERVICE_HANDLE   (0x0013u) /* Handle of RGB_LED service */
#define CYBLE_RGB_LED_RGB_DATA_DECL_HANDLE   (0x0014u) /* Handle of RGB_DATA characteristic declaration */
#define CYBLE_RGB_LED_RGB_DATA_CHAR_HANDLE   (0x0015u) /* Handle of RGB_DATA characteristic */
#define CYBLE_RGB_LED_RGB_DATA_CHARACTERISTIC_USER_DESCRIPTION_2_DESC_HANDLE   (0x0016u) /* Handle of Characteristic User Description 2 descriptor */
#define CYBLE_RGB_LED_RGB_DATA_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_HANDLE   (0x0017u) /* Handle of Client Characteristic Configuration descriptor */
